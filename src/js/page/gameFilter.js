...
<button type="button" class="input-dropdown-btn" data-toggle="dropdown" aria-expanded="false"> 
<span id="customLabel" class="rbx-selection-label ng-binding" ng-bind="layout.selectedTab.label">${chrome.i18n.getMessage("moreFilters")}</span> 
<span class="icon-down-16x16"></span></button>
...
var filters = [chrome.i18n.getMessage("moreFilters"), "Single-player", "Gear Allowed", "Paid Access", "New Games", "Classic Games", "Recently Updated", "Updated Today", "Under 1m Visits", "R15 Enabled", "Open Source"]
