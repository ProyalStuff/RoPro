...
function addOpenThemesButton(){
	div = document.createElement('div')
	div.innerHTML += '<a id="openThemes" style="margin-left:10px;display:inline-block;" class="btn-primary-md ng-binding">' + chrome.i18n.getMessage("ChangeProfileTheme") + '</a>'
	...
	document.getElementById('openThemes').addEventListener('click', function(){
		if (this.innerHTML == chrome.i18n.getMessage("ChangeProfileTheme")) {
			loadThemes()
			this.innerHTML = chrome.i18n.getMessage("CloseProfileThemes")
		} else {
			this.innerHTML = chrome.i18n.getMessage("ChangeProfileTheme")
