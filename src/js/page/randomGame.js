...
randomGameButtonHTML = '<a id="randomGameButton" class="btn-growth-md btn-secondary-md random-game-button" style="border-radius:0px;text-align:right;width:auto;min-width:179px;position:absolute;right:170px;"><img style="width:30px;margin-top:-50px;margin-bottom:-50px;margin-right:5px;" src="https://ropro.io/images/dice_' + theme + '.png">'+ chrome.i18n.getMessage("RandomGame") +'</a>'
...
function createRandomGameButton() {
    ...
    randomGameButton.addEventListener("click", function() {
		if (randomGameButton.innerHTML.includes(chrome.i18n.getMessage("RandomGame"))) {
			...
			randomGameButton.innerHTML = '<img style="width:30px;margin-top:-50px;margin-bottom:-50px;margin-right:5px;" src="https://ropro.io/images/dice_' + theme + '.png">' + chrome.i18n.getMessage("RandomGame")
