...
async function getBorderColor() {
    borderAA = await getStorage('PESearcherColor');
    return borderAA;
}


async function displayServer(server, url){
    ...
    server.CurrentPlayers.forEach((val, idx) => {
        ...
        if (val.Thumbnail.Url == url) {
            async function skrrt() {
                borderColor = await getStorage('PESearcherColor');
                console.log(borderColor)
                console.log('this is him chief')
                if (typeof(borderColor) !== 'undefined') {
                    console.log('defined :)')
                    var borderColor = borderColor.replace("#", "");
                }
                else {
                ...
                console.log('Border Color Setting: ' + borderColor)
...
async function initiateRo() {
    if(runningGames !== null) {
        if (await fetchSetting("roSearcher")) {
